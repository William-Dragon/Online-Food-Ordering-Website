                    ...
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon">+92</span>
                            </div>
                            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Phone No" required pattern="(\+92)?[0-9]{10}" maxlength="12">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
                ...
                <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $phone; ?>" required pattern="(\+92)?[0-9]{10}" maxlength="12">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Type:</label></b>
